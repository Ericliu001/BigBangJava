package com.ericliu.threading.taskgang;
...
public class TaskGangTest {
     ...
     * search a fixed number of words concurrently until there's no
    ...
    /**
     * This input array is used by the cyclic test that continues to
     * search a variable number of words concurrently until there's no
     * more input to process.
     */
